...
Target host: `vibeos.mwmai.no` — Hetzner CX43 (204.168.244.173), already
running Caddy. Caddy vhost for this subdomain ships in
`../caddy/vibeos.mwmai.no.caddy`.
...
scp packages/local/vibeos-*.deb ops@vibeos.mwmai.no:/tmp/
ssh ops@vibeos.mwmai.no
  cd /srv/apt-repo
...
echo 'deb https://vibeos.mwmai.no/ noble main' \
